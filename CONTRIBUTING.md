...
[create a Pull Request](https://github.com/fv3rdugo/sca_pbs4_hardening_independent/pulls)
...
```sh
git remote add upstream https://github.com/fv3rdugo/sca_pbs4_hardening_independent.git
git fetch upstream
...
```sh
git remote add upstream git@github.com:fv3rdugo/sca_pbs4_hardening_independent.git
git fetch upstream
git checkout main
...
```sh
git remote add upstream https://github.com/fv3rdugo/sca_pbs4_hardening_independent
git fetch upstream
```
